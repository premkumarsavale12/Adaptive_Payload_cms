...
const SearchInput = ({
    ...
    <div className="sticky xmd:top-[90px] top-[200px] xmd:px-0 px-2 z-50 py-4  border-t-[1px] border-t-solid xmd:border-t-transparent border-t-black-200 bg-white-100  border-b-[1px] border-b-solid border-b-black-200">
