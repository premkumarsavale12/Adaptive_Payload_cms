            ...
            <div className="btm-col-left flex flex-col space-y-8 xmd:w-1/2 w-full">
              ...
              {button?.label && button?.url && (
                <Link
                  ...
                  role="link"
                >
                  <div className="btn-pink inline-flex w-auto items-center justify-center bg-green font-overpass font-medium text-black text-[body] px-4 py-2 border-solid border-[1.5px] border-transparent hover:bg-transparent hover:border-green transition-all duration-480 ease-in-out cursor-pointer">
                    {button.label}
                  </div>
                </Link>
              )}
