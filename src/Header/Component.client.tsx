...
export const HeaderClient: React.FC<HeaderClientProps> = ({ data }) => {
  ...
  useEffect(() => {
    // Close the mobile sidebar when navigation occurs
  ...
  return (
    <>
      ...
      >
        ...
        <div className="haeder-btm lg:py-0 py-[34px] border-b-black-200 border-b-solid border-b-[1px] w-full left-0 top-0  bg-white">
          <div className="container">
            <div className="w-full flex justify-between items-center gap-3 2xl:gap-8">
              ...
              <div
                className={`curtain lg:static fixed left-0 top-0 lg:w-auto w-full lg:h-auto h-full lg:bg-transparent bg-[rgba(0,0,0,0.5)] lg:opacity-1 lg:visible transition duration-300 z-[9999] ${isSidebarOpen
                  ? "translate-x-0"
                      ...
                      lg:bg-white bg-transparent
                          ...
                          `}
                            ...
                            >
                              ...
                              {layout === 'mega' && (
                                <div
                                  className="flex flex-col lg:grid gap-x-10 gap-y-4 p-6 text-white lg:text-black"
                                  style={!isMobile() ? {
